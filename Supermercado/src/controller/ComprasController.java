...
public class ComprasController {
	...
	public ComprasController(Compras view, Frame frame) {
		...
		this.carrinhoController = new CarrinhoController(carrinhoView, frame.getUsuarioLogado(),
				frame.getProdutoController(), new CarrinhoDAO(), frame);
	...
	private void carregarProdutos() {
		...
		for (Produto p : produtoDAO.listarProdutos()) {
			modelo.addRow(new Object[] { p.getId(), p.getNome(), p.getPreco(), p.getQtde() });
		}
	}
