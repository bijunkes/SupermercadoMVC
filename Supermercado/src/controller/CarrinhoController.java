...
public class CarrinhoController {
    ...
    private void atualizarCamposLinhaSelecionada(int linha) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao atualizar informações da linha.");
        }
    }
    ...
    private void atualizarQuantidade(int linha, int novaQtde) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro: quantidade inválida na tabela.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Erro inesperado ao atualizar a quantidade.");
        }
    }
    ...
    public boolean adicionarProduto(int idUsuario, int idProduto, int qtde, double preco) {
        ...
        model.Carrinho c = new model.Carrinho(
            0,
            idUsuario,
            idProduto,
            qtde,
