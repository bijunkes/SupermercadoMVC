...
public class CadastroController {
	...
	private void cadastrarUsuario() {
		try {
			...
			if (existente != null) {
				JOptionPane.showMessageDialog(view, "Já existe um usuário cadastrado com esse nome e CPF.", "Aviso",
			...
			if (sucesso) {
				...
				JOptionPane.showMessageDialog(view, "Erro ao cadastrar usuário. Verifique os dados e tente novamente.",
						"Erro", JOptionPane.ERROR_MESSAGE);
			}

		} catch (Exception ex) {
			JOptionPane.showMessageDialog(view, "Ocorreu um erro inesperado ao processar o cadastro.", "Erro",
